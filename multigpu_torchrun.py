...
def main(config):
    ...
    train_data, model, optimizer, scheduler = load_train_objs(config)
    trainer = Trainer(model, train_data, optimizer, config.save_every, config.model)
